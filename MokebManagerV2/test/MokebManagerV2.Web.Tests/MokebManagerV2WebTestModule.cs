...
[DependsOn(
    ...
    typeof(MokebManagerV2WebModule),
    typeof(MokebManagerV2ApplicationTestModule),
    typeof(MokebManagerV2EntityFrameworkCoreTestModule)
)]
public class MokebManagerV2WebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(MokebManagerV2WebModule).Assembly));
        });
